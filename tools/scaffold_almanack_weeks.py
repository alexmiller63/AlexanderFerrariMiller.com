...
def main():
    ...
    for year,week,monday in selected_weeks(a.start_year,a.start_week,ey,ew):
        out=PUBLIC_ROOT/str(year)/f'W{week:02d}'; out.mkdir(parents=True,exist_ok=True); (out/'index.html').write_text(page(year,week,monday),encoding='utf-8'); count+=1
