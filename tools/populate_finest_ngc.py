...
ROOT=Path(__file__).resolve().parents[1]; SRC=ROOT/"Historical"; PUBLIC=ROOT/"almanack"; SOURCE_SITE=SRC/"site"; CATALOG=SRC/"finest-ngc-catalog.csv"; CALDWELL=SRC/"finest-ngc-caldwell-overlap.csv"
