...
text = '''from planet_finder_geometry import conjunction_groups, conjunction_glyph_radii
...
print("Installed progressive Planet Finder QA ladder: separated bodies -> one alignment -> two -> triple -> W2 regression.")
