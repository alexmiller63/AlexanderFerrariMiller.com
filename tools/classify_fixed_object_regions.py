...
The authoritative fixed-object catalog remains ``Star-Almanack-Repo/fixed-objects.yaml``.
Derived region membership is written to the companion catalog
``Star-Almanack-Repo/fixed-object-regions.yaml`` so future Milky Way subregions
...
OUTPUT = ROOT / "Star-Almanack-Repo" / "fixed-object-regions.yaml"
